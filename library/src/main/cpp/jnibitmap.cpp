...
/*extern "C" {
  JNIEXPORT void JNICALL Java_com_pcm_library_JniBitmap_floodFill(JNIEnv * env, jobject obj, jobject handle, uint32_t x, uint32_t y, uint32_t color, uint32_t tolerance);
...
Java_com_pcm_library_JniBitmap_floodFill(JNIEnv *env, jobject obj, jobject bitmap, uint32_t x,
                                         uint32_t y, uint32_t color, uint32_t tolerance) {
...
void
floodFill(uint32_t x, uint32_t y, uint32_t color, void *bitmapPixels, AndroidBitmapInfo *bitmapInfo,
          uint32_t tolerance) {
